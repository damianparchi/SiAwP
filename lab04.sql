-- Stwórz funkcje:
-- 1.Zwracającą nazwę pracy dla 
-- podanego parametru id, dodaj wyjątek, jeśli taka praca nie istnieje
...
-- 2. zwracającą roczne zarobki (wynagrodzenie 12-to miesięczne plus premia 
...
-- 4. Dla podanego w parametrze ciągu 
-- znaków zmieniającą pierwszą i ostatnią 
...
-- 5. Dla podanego peselu - przerabiającą 
-- pesel na datę urodzenia w formacie ‘yyyy-mm-dd’
...
-- 6. Zwracającą liczbę pracowników oraz liczbę departamentów 
-- które znajdują się w kraju podanym jako parametr (nazwa kraju). 
...
-- 1.	Stworzyć tabelę archiwum_departamentów (id, nazwa, 
-- data_zamknięcia,
-- ostatni_manager jako imię i nazwisko). 
-- Po usunięciu departamentu dodać odpowiedni rekord 
-- do tej tabeli
...
-- 2.	W razie UPDATE i INSERT na tabeli employees, 
-- sprawdzić czy zarobki łapią się w widełkach 2000 - 26000. 
-- Jeśli nie łapią się - zabronić dodania. 
-- Dodać tabelę złodziej(id, USER, czas_zmiany), 
-- której będą wrzucane logi, jeśli będzie próba dodania, 
-- bądź zmiany wynagrodzenia poza widełki.
